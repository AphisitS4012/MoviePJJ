...
const API_KEY = 'd2bc12f34a281b5845940d02193a9ab3';
const SearchBox = () => {
                ...
                <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <div class="flex md:order-2">
                        ...
                        <div class="relative hidden md:block">
                            ...
                            {/* <input type="text" value={setSearchTerm} onChange={(e) => setSearchTerm(e.target.value)} className='block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"' placeholder='Search...' /> */}
